...
define view ZI_PROGRESSO_PROJETO
  as select from ZIDLA01GP_PROJECT as p
  ...
  association [1..1] to Z_TOTAL_HORAS_PROJETO_CUBE     as _thp  on $projection.Id = _thp.Projeto
{
  ...
  key Id,
      ...
      cast(
        cast(_thap.HorasApontadas * 100 as abap.decfloat34) / 
        cast(_thp.HoursExpected as abap.decfloat34) 
      as abap.int1) as Progresso,
      /* Associations */
      _thap,
      _thp
}
